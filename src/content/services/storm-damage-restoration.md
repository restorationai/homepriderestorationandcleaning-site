...
priority: 8.1
plan_hash: "6e4ceed68dd94471"
generated_at: "2026-06-15T18:23:08.046338+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/american-fork-ut/storm-damage-restoration/", "/service-areas/eagle-mountain-ut/storm-damage-restoration/", "/service-areas/herriman-ut/storm-damage-restoration/", "/service-areas/lehi-ut/storm-damage-restoration/", "/service-areas/orem-ut/storm-damage-restoration/", "/service-areas/pleasant-grove-ut/storm-damage-restoration/", "/service-areas/provo-ut/storm-damage-restoration/", "/service-areas/riverton-ut/storm-damage-restoration/", "/service-areas/south-jordan-ut/storm-damage-restoration/", "/blog/storm-damage-insurance-claim-checklist/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Storm Damage Restoration"}]
faq: [{"question": "My roof was breached during the storm but it's not raining right now. Do I still need emergency tarping right away?", "answer": "Yes. Utah Valley's spring and summer storm seasons mean another weather event can arrive within 24\u201348 hours of the first. An unprotected breach also allows ongoing humidity and temperature fluctuations to accelerate moisture migration into the wall and ceiling assemblies below \u2014 damage that accumulates even without active rain. Emergency tarping is about limiting total scope, not just stopping the current rain."}, {"question": "How do I know if water got into my walls after a storm, even if I don't see visible staining?", "answer": "Surface staining is often a lagging indicator \u2014 it appears after moisture has already migrated through the assembly. Thermal imaging cameras detect temperature differentials caused by evaporative cooling in wet materials, and calibrated moisture meters can read elevated moisture content in framing and sheathing behind drywall. A post-storm inspection that includes both tools will find intrusion that a visual walk-through misses entirely."}, {"question": "What documentation does my insurance company typically require for a storm damage claim?", "answer": "Most carriers want dated photographs of the breach and all affected areas taken before and after stabilization, a written damage assessment that distinguishes storm-caused damage from pre-existing conditions, and moisture readings with equipment identification and measurement dates. A detailed repair scope with line-item costs is also standard. Gaps in this documentation are the most common reason storm claims are delayed or partially denied."}, {"question": "A tree fell on my roof but the damage looks minor from the attic. Can I just patch it myself?", "answer": "Impact from a falling tree or large limb can crack or displace roof decking, compress or fracture rafters, and shift flashing at the ridge or valleys \u2014 damage that isn't always visible from a single attic vantage point. A professional assessment checks the full structural load path, not just the point of contact. Patching a surface breach over compromised framing or wet sheathing typically leads to a larger failure within one to two seasons."}, {"question": "How long after a storm can mold begin developing in water-damaged areas of my home?", "answer": "Under typical indoor conditions \u2014 temperatures between 60\u201380\u00b0F and elevated moisture \u2014 mold can begin colonizing organic materials like drywall paper, wood framing, and insulation within 24\u201372 hours of a water intrusion event. In Utah's summer months, when attic and wall cavity temperatures are higher, that window can be shorter. This is why structural drying with active equipment, not just ventilation, matters: the goal is getting materials below 16% moisture content before the colonization window closes."}]
