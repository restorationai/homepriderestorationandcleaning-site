...
priority: 8.1
plan_hash: "4b79de62b89980a5"
generated_at: "2026-06-15T18:23:14.368893+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/american-fork-ut/smoke-damage-restoration/", "/service-areas/eagle-mountain-ut/smoke-damage-restoration/", "/service-areas/herriman-ut/smoke-damage-restoration/", "/service-areas/lehi-ut/smoke-damage-restoration/", "/service-areas/orem-ut/smoke-damage-restoration/", "/service-areas/pleasant-grove-ut/smoke-damage-restoration/", "/service-areas/provo-ut/smoke-damage-restoration/", "/service-areas/riverton-ut/smoke-damage-restoration/", "/service-areas/south-jordan-ut/smoke-damage-restoration/", "/blog/fire-damage-restoration-process/", "/blog/smoke-odor-removal-techniques/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Smoke Damage Restoration"}]
faq: [{"question": "What is the difference between dry soot, wet soot, and protein residue, and why does it change how cleanup is done?", "answer": "Dry soot comes from wood, paper, and low-temperature fires \u2014 it's powdery, travels far, and must be vacuumed and lifted with dry-cleaning sponges before any wet product is applied. Wet soot results from synthetic materials burning at high heat; it smears on contact and requires chemical pre-treatment to avoid permanent staining. Protein residue from kitchen fires is nearly invisible but carries an intense odor and bonds tightly to painted surfaces, requiring enzymatic or solvent-based cleaners. Misidentifying the soot type and using the wrong method is the single most common cause of incomplete smoke cleanup."}, {"question": "How does thermal fogging work, and is it safe for my home?", "answer": "Thermal fogging uses heat to vaporize a deodorizing solution into particles roughly the same size as smoke, allowing the fog to penetrate the same wall cavities, subfloor gaps, and attic spaces that smoke reached during the fire. The deodorizer oxidizes odor-causing compounds on contact rather than masking them. The structure needs to be vacated during treatment and ventilated afterward \u2014 typically a few hours \u2014 before re-occupancy. It's one of the most effective tools for eliminating deep-set smoke odor that surface cleaning alone can't reach."}, {"question": "My house was affected by wildfire smoke but didn't have a fire \u2014 do I still need professional smoke damage restoration services?", "answer": "Yes, and wildfire smoke presents its own set of challenges. The particulate from wildland fires is extremely fine, penetrates HVAC systems readily, and deposits on interior surfaces even in homes that appear unaffected. Extended exposure to wildfire smoke indoors can leave a persistent odor and elevated particulate levels in ductwork. A professional assessment typically includes duct inspection, air scrubbing, and surface deodorization \u2014 the scope depends on how long the home was exposed and how well it was sealed during the smoke event."}, {"question": "Why does smoke odor sometimes come back weeks after a fire, even after the house was cleaned?", "answer": "Smoke residue inside wall cavities, subfloor assemblies, and ductwork continues to off-gas long after visible surfaces are cleaned. If the cleaning process addressed only surfaces and didn't include thermal fogging, ozone or hydroxyl treatment, and ductwork inspection, the odor source is still present \u2014 it's just temporarily covered. Warm weather, running the HVAC system, or increased humidity can accelerate off-gassing and make the odor reappear. A proper post-fire smoke cleanup addresses the structure in three dimensions, not just the walls you can reach with a sponge."}, {"question": "What documentation should I expect from a smoke damage restoration company for my insurance claim?", "answer": "Your restoration contractor should provide a written scope of work identifying the soot type, affected areas, and cleaning methods used; before-and-after photographs of all affected surfaces and contents; an itemized contents inventory if pack-out was performed; and records of any equipment deployed (air scrubbers, thermal foggers, ozone generators). Insurance adjusters reviewing smoke damage claims look specifically for evidence that ductwork was inspected and that deodorization methods consistent with IICRC S700 standards were applied \u2014 not just surface wiping. Home Pride Restoration and Cleaning (License #RC-25-0737) provides complete documentation as a standard part of every job."}]
...
IICRC-certified technicians are trained on the S700 Standard for Professional Smoke and Soot Restoration, which defines these protocols. That certification matters when your insurance carrier reviews the work.
