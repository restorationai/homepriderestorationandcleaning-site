...
priority: 6.3
plan_hash: "16d397c7b92964fb"
generated_at: "2026-06-15T18:29:55.474208+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/american-fork-ut/frozen-pipe-restoration/", "/service-areas/eagle-mountain-ut/frozen-pipe-restoration/", "/service-areas/herriman-ut/frozen-pipe-restoration/", "/service-areas/lehi-ut/frozen-pipe-restoration/", "/service-areas/orem-ut/frozen-pipe-restoration/", "/service-areas/pleasant-grove-ut/frozen-pipe-restoration/", "/service-areas/provo-ut/frozen-pipe-restoration/", "/service-areas/riverton-ut/frozen-pipe-restoration/", "/service-areas/south-jordan-ut/frozen-pipe-restoration/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Frozen Pipe Restoration"}]
faq: [{"question": "How do I know if my pipe froze and thawed without bursting?", "answer": "A pipe that froze and re-pressurized without splitting will usually show no symptoms \u2014 but that doesn't mean there's no damage. Repeated freeze-thaw cycles cause micro-fractures and joint stress that can fail weeks later under normal pressure. If you had a hard freeze and your water pressure felt low or sputtering for a period, it's worth having supply lines in exterior walls and unconditioned spaces inspected before the next cold snap."}, {"question": "What building materials are hardest to dry after a frozen pipe thaws?", "answer": "Engineered hardwood and laminate flooring are among the most problematic \u2014 they cup, buckle, and delaminate quickly and often cannot be saved once fully saturated. Blown-in cellulose insulation is another problem material; it holds moisture tenaciously and must be removed rather than dried in place. Concrete subfloors under floating floors trap moisture at the interface and require extended drying times with desiccant or specialty equipment."}, {"question": "What should I do between discovering the leak and when your technician arrives?", "answer": "Shut off water at the main valve or the zone valve serving the affected area immediately \u2014 this is the single most important step. Move furniture, rugs, and electronics out of the wet zone if it's safe to do so. Do not use a standard household fan to dry the area; without dehumidification running in parallel, fans can spread moisture into adjacent materials. Take photos of the damage before moving anything, since that documentation supports your insurance claim."}, {"question": "Why does frozen pipe damage often affect rooms far from where the pipe actually burst?", "answer": "Water under pressure follows the path of least resistance through a structure \u2014 wall cavities, the gap between subfloor and finish floor, and top-plate penetrations where pipes and wires pass between floors. A burst pipe in a second-floor bathroom can saturate a first-floor ceiling twelve feet away before it ever shows on the surface. Thermal imaging and moisture mapping are essential for tracing the full extent of intrusion rather than treating only what's visible."}, {"question": "What does a drying log include, and why do insurance adjusters require it?", "answer": "A drying log records daily moisture readings at each monitoring point, the equipment in use, ambient temperature and relative humidity, and the technician's observations \u2014 typically over the 3\u20137 day drying period. Adjusters require it because it's the only objective evidence that structural drying was completed to the IICRC S500 standard rather than just surface-dried. Without it, carriers may dispute whether remediation was necessary or complete, which can delay or reduce your settlement."}]
...
1. **Emergency response and source confirmation.** A technician arrives and locates the burst or split pipe. If the leak is still active, we coordinate immediate shut-off at the main or zone valve before any restoration work begins. We document the pipe location, failure point, and visible damage with photos for your insurance claim.
...
Insurance adjusters look for three things in a frozen pipe claim: a drying log with daily moisture readings, documentation of the pipe failure point, and evidence that wet insulation was removed rather than dried in place. Carriers increasingly deny or reduce claims when these records are absent, because they can't verify that drying was actually completed to standard.

IICRC-certified technicians follow the S500 Standard for Professional Water Damage Restoration, which defines drying goals, documentation requirements, and material-specific protocols. That certification matters when your adjuster is reviewing the scope.
