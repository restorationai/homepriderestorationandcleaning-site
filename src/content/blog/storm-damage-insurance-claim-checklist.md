...
faq: [{"question": "Does filing a storm damage claim raise my homeowners insurance rates?", "answer": "It depends on your insurer and your claim history. A single weather-related claim \u2014 hail, wind, flooding from a storm \u2014 is generally treated differently than an at-fault claim like a fire caused by negligence. That said, some insurers do adjust rates after any claim. It's worth calling your agent to ask about your specific policy before filing, especially for smaller losses where the repair cost is close to your deductible."}, {"question": "What if the storm happened weeks ago \u2014 is it too late to file a claim?", "answer": "Probably not, but act now. Most Utah homeowners' policies require you to report damage within a reasonable timeframe, which is typically defined as 30 to 60 days \u2014 though some policies allow up to a year for certain types of storm damage. The bigger practical problem is that delayed claims are harder to document: weather data gets older, damage can be attributed to wear and tear rather than the storm event, and secondary damage like mold can complicate the original claim. File as soon as possible and gather whatever storm-date evidence you can."}, {"question": "Can I get my own contractor estimate before the insurance adjuster comes out?", "answer": "Yes, and it's often a smart move. A professional restoration contractor's written scope \u2014 with moisture readings, photos, and line-item estimates \u2014 gives you an independent baseline to compare against the adjuster's assessment. If the adjuster's estimate comes in lower, your contractor can submit a supplement request with supporting documentation. You are not obligated to accept the first number the insurance company offers."}, {"question": "What's the difference between a public adjuster and the adjuster my insurance company sends?", "answer": "The adjuster your insurance company sends works for the insurer \u2014 their job is to assess the claim accurately, but their employer's interest is in paying what the policy requires, not more. A public adjuster is an independent licensed professional you hire to represent your interests in the claims process. They typically charge a percentage of the final settlement (often 10\u201315%). They're most useful when a claim is large, complex, or when the initial settlement offer feels significantly lower than your contractor's scope."}]
...
Don't grab your phone and start filming the moment the storm passes. First, do a quick safety sweep.
...
- Are you IICRC-certified for water damage and storm restoration?
