...
faq: [{"question": "Can a DIY mold test kit tell me if the mold in my home is dangerous?", "answer": "Not reliably. Most consumer kits identify mold genera (like Aspergillus or Cladosporium) but can't determine species or spore concentration \u2014 both of which matter when assessing risk. A professional air sample with an accredited lab report provides spore counts per cubic meter and species-level identification, which gives a much clearer picture. Even then, a mold inspector is not a physician; questions about health effects should go to a doctor, not a test kit or an inspector."}, {"question": "How much does a professional mold inspection typically cost?", "answer": "In Utah, professional mold inspections with air and surface sampling generally run between $300 and $600 for a standard single-family home, depending on the number of samples collected and the size of the property. That price typically includes the lab fees and a written report. Some companies charge separately for post-remediation verification testing, so ask upfront what's included. Homeowner's insurance rarely covers the inspection itself, though remediation costs may be covered if the mold resulted from a covered water loss."}, {"question": "How long does it take for mold to grow after a water leak?", "answer": "Under warm, humid conditions, mold can begin colonizing porous materials like drywall, insulation, and wood framing within 24 to 48 hours of sustained moisture exposure. In Utah's drier climate, that window can stretch slightly longer, but it's not a reliable buffer \u2014 especially in enclosed spaces like wall cavities or under flooring where humidity stays elevated even when the surface feels dry. The practical rule is: if materials stayed wet for more than 48 hours, treat it as a potential mold situation until proven otherwise."}, {"question": "What's the difference between mold testing and mold remediation \u2014 do I need both?", "answer": "Testing (or inspection) is the diagnostic step: it identifies whether mold is present, where it is, and what type it is. Remediation is the physical removal and treatment process. You don't always need a formal inspection before remediation \u2014 if mold is clearly visible over a large area, a remediation contractor can often assess the scope directly. However, testing becomes important when the source is hidden, when you need documentation for insurance or a real estate transaction, or when you want independent verification after remediation is complete."}]
...
## Signs You're Dealing with More Than a Surface Stain
