...
priority: 6.3
plan_hash: "40be993658bd6775"
generated_at: "2026-06-15T18:35:19.655478+00:00"
manual_override: false
internal_links: ["/services/storm-damage-restoration/", "/service-areas/herriman-ut/", "/service-areas/herriman-ut/fire-damage-restoration/", "/service-areas/herriman-ut/mold-remediation/", "/service-areas/american-fork-ut/storm-damage-restoration/", "/service-areas/eagle-mountain-ut/storm-damage-restoration/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Herriman", "url": "/service-areas/herriman-ut/"}, {"name": "Storm Damage Restoration"}]
faq: [{"question": "How quickly can Home Pride reach a home in southern Herriman (84096) after a storm?", "answer": "From our Saratoga Springs headquarters, we can typically reach most Herriman addresses within 45\u201360 minutes via Redwood Road or Bangerter Highway. Homes in the northern sections of Herriman, closer to the Saratoga Springs boundary, are often reachable in 30 minutes or less. During widespread storm events affecting multiple properties simultaneously, we dispatch the nearest crew first and stage additional teams behind them."}, {"question": "Does Herriman's clay-heavy soil affect how water damage spreads after a storm?", "answer": "Yes, significantly. The clay-dominant soil common on Herriman's benchlands sheds water rather than absorbing it, which means heavy rainfall channels quickly toward foundations, window wells, and below-grade entries. Homes that have never experienced flooding can take on water in a single intense storm event. We account for this drainage pattern during our initial site assessment and check foundation perimeters and window well drains as part of every storm response."}, {"question": "My Herriman HOA has strict rules about exterior materials \u2014 will that affect repairs?", "answer": "It can, and we address it before ordering materials rather than after. Many Herriman subdivisions maintain approved product lists for roofing, siding, and fencing. We contact the HOA directly to verify approved colors and materials before any replacement work begins, which prevents the cost and delay of redoing completed repairs. We also document all HOA correspondence as part of the job file."}, {"question": "What does the tree damage cleanup process look like for a large tree fall on a Herriman home?", "answer": "We start by securing the structure \u2014 tarping any roof penetrations and boarding compromised openings \u2014 before debris removal begins. Smaller limbs and surface debris are cleared by our own crews. For large tree falls where the root ball or remaining trunk requires a crane or specialized rigging, we coordinate with a licensed arborist and keep the project moving under a single point of contact. All debris is hauled off-site, and the structural damage underneath is assessed and documented for your insurance claim."}, {"question": "How long does structural drying typically take after storm-related water intrusion in a Herriman home?", "answer": "Most residential drying projects in Herriman run 3\u20135 days under normal conditions, though that timeline extends if water has reached wall cavities, subfloor assemblies, or insulation. We monitor moisture readings daily with calibrated meters and pull equipment only when readings return to pre-loss baselines \u2014 not on a fixed schedule. Herriman's lower humidity compared to coastal climates actually works in your favor here, as drier ambient air allows dehumidifiers to work more efficiently."}]
...
1. **Emergency tarping and board-up**, open roof sections, broken windows, and compromised doors are secured within the first hour to prevent additional water intrusion or wind damage.
2. **Water extraction and drying**, any standing water is extracted immediately. Structural drying equipment (desiccant dehumidifiers and high-velocity air movers) is deployed and monitored daily until moisture readings return to pre-loss baselines.
3. **Debris removal and tree damage cleanup**, downed limbs and structural debris are cleared and hauled. For larger tree falls, we coordinate with licensed arborists when root systems or remaining trunk sections require specialized equipment.
4. **Structural assessment and repair**, roof decking, framing, siding, insulation, and interior finishes are repaired or replaced to current Utah building code, with all work documented for permit and insurance purposes.
