...
priority: 5.6
plan_hash: "07fbbd68f71a86d2"
generated_at: "2026-06-15T18:38:37.409858+00:00"
manual_override: false
internal_links: ["/services/basement-flooding-cleanup/", "/service-areas/eagle-mountain-ut/", "/service-areas/eagle-mountain-ut/fire-damage-restoration/", "/service-areas/eagle-mountain-ut/mold-remediation/", "/service-areas/american-fork-ut/basement-flooding-cleanup/", "/service-areas/herriman-ut/basement-flooding-cleanup/", "/contact/"]
...
faq: [{"question": "How quickly can you reach homes in the Ranches or Overland communities in Eagle Mountain?", "answer": "From our Saratoga Springs headquarters, most Eagle Mountain neighborhoods are 10 to 15 minutes away via Redwood Road and Eagle Mountain Boulevard. Homes in the Overland community or along Pony Express Parkway may be closer to 20 minutes depending on traffic. In practice, most Eagle Mountain callers have a technician on-site within 60 to 90 minutes of their first call."}, {"question": "Is basement flooding from a sump pump failure covered by homeowner's insurance in Eagle Mountain?", "answer": "Sump pump failure coverage depends on whether your policy includes a water backup or sump overflow endorsement \u2014 standard homeowner's policies often exclude it unless that rider is added. Sudden pipe bursts are typically covered under the base policy. We document the loss thoroughly from arrival so your adjuster has everything needed to process the claim, and we can communicate directly with your carrier on your behalf."}, {"question": "Eagle Mountain's soils are heavy clay \u2014 does that affect how long basement drying takes?", "answer": "It can, indirectly. Clay soil holds moisture against foundation walls longer than sandy or loam soils, which means hydrostatic pressure continues even after interior water is extracted. We account for this by monitoring wall cavity moisture levels daily and adjusting dehumidifier placement as needed. In homes where water has wicked into concrete block or poured walls, drying timelines can run 3 to 5 days rather than the 2 to 3 days typical for above-grade water damage."}, {"question": "What happens if mold is already growing by the time you arrive at an Eagle Mountain home?", "answer": "Mold can begin colonizing porous materials within 24 to 48 hours of a moisture event, so it's not uncommon in cases where a slow leak went undetected. If our moisture mapping and visual inspection indicate active mold growth, we'll identify the affected areas and discuss remediation options separately from the drying scope. We don't treat mold as a footnote \u2014 it requires its own protocol, and we'll be direct with you about what we find."}, {"question": "Do newer Eagle Mountain homes built during the mid-2000s construction boom have specific vulnerabilities for basement flooding?", "answer": "Yes \u2014 homes built quickly during that period sometimes have thinner concrete foundation walls, minimal exterior waterproofing membrane, and window wells that weren't sized for the drainage load the lots actually receive. We see hairline foundation cracks and failed window well drains frequently in that housing stock. During our initial assessment, we note any structural vulnerabilities that contributed to the intrusion so you have that information for repairs after the drying is complete."}]
...
- **Water extraction** using truck-mounted and portable extractors capable of removing hundreds of gallons from a finished or unfinished basement
- **Moisture mapping** with thermal imaging cameras and calibrated moisture meters to find water that has wicked into walls, under flooring, and into insulation cavities
- **Structural drying** using industrial-grade desiccant or refrigerant dehumidifiers and high-velocity air movers, positioned based on the room's layout and material types
- **Antimicrobial treatment** on affected surfaces to slow microbial growth during the drying period
- **Daily monitoring** with documented moisture readings so the drying timeline is defensible for your insurance claim

Our IICRC-certified technicians follow the S500 Standard for Water Damage Restoration, which matters when your adjuster reviews the claim documentation.
