...
priority: 6.3
plan_hash: "50c0a969fe0301c2"
generated_at: "2026-06-15T18:34:43.249078+00:00"
manual_override: false
internal_links: ["/services/sewage-cleanup/", "/service-areas/herriman-ut/", "/service-areas/herriman-ut/fire-damage-restoration/", "/service-areas/herriman-ut/mold-remediation/", "/service-areas/american-fork-ut/sewage-cleanup/", "/service-areas/eagle-mountain-ut/sewage-cleanup/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Herriman", "url": "/service-areas/herriman-ut/"}, {"name": "Sewage Cleanup and Sanitization"}]
faq: [{"question": "How quickly can a crew reach a sewage backup in Herriman's newer slab-on-grade subdivisions near the Mountain View Corridor?", "answer": "From the Saratoga Springs headquarters, most Herriman addresses are reachable in 20 to 35 minutes via Bangerter Highway and 11400 South. Subdivisions closer to the Mountain View Corridor on the south end of the city typically add no more than 5 to 10 minutes. Calling immediately after the backup is discovered \u2014 before attempting any cleanup \u2014 keeps that response window as useful as possible."}, {"question": "Does Herriman's expansive clay soil affect how a sewage backup is cleaned up compared to other parts of Salt Lake County?", "answer": "It does, in a couple of ways. The ground movement associated with Herriman's clay-heavy soils can offset sewer lateral joints, which sometimes means the backup recurs until the line is properly repaired \u2014 we document the source carefully so the plumber has a clear picture. It also means subfloor assemblies in affected homes can hold moisture longer than in areas with sandier soil profiles, so drying timelines are monitored closely rather than estimated by a fixed number of days."}, {"question": "My Herriman HOA says the sewer backup originated in a shared line \u2014 whose insurance pays for the cleanup inside my home?", "answer": "This is a common situation in Herriman's planned communities, and the answer depends on where the blockage is documented to have originated. If it's in a common-area line, the HOA's master policy is typically the first to respond for interior damage caused by that backup. Thorough documentation of the loss origin \u2014 photos, video scope if available, moisture readings \u2014 is what makes that determination clear for both adjusters. The team can help compile that documentation from the first hour on-site."}, {"question": "What does Category 3 sewage cleanup actually involve, and why can't I handle it with a shop vac and bleach?", "answer": "Category 3 water contains bacteria, viruses, and parasites at concentrations that household disinfectants applied casually won't neutralize \u2014 bleach diluted in standing water loses effectiveness quickly and doesn't penetrate porous materials. Professional extraction removes the bulk contamination first, then EPA-registered hospital-grade disinfectants are applied with proper dwell times to surfaces that have been cleaned down to bare material. Porous items with direct sewage contact \u2014 carpet, drywall, insulation \u2014 are removed entirely because no surface treatment reliably decontaminates them."}, {"question": "How long does a typical sewage cleanup and sanitization job take in a Herriman slab-on-grade home?", "answer": "Extraction and initial sanitization on a contained backup \u2014 one bathroom or utility area \u2014 usually takes 4 to 8 hours for the first day of work. Structural drying after a sewage event typically runs 3 to 5 days depending on how far moisture migrated under the slab and into wall cavities. Homes in the 84096 ZIP code with slab construction are monitored with thermal imaging and pin meters throughout that drying period to confirm the subfloor perimeter is fully dry before any reconstruction begins."}]
